          ...
          <div className="heute-aside">
            ...
            <a href="https://drive.google.com/drive/folders/1m5C3dj_wwtPQF1abJPuqmR8wZ1GdBu83?usp=sharing" target="_blank" rel="noreferrer" className="drive-link-card">
              ...
              <div className="drive-link-body">
                <div className="drive-link-title">QUADRAS Dokumente</div>
                <div className="drive-link-sub">Google Drive · Alle Dateien</div>
              </div>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" style={{color:'var(--muted)',flexShrink:0}}><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
            </a>
